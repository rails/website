...
layout: company
title: Shopify
description: "Shopify is a founding Core member of the Rails Foundation since 2022, and one of the biggest Rails success stories."
name: Shopify
intro: |
...
exturl: https://www.shopify.com/
company_type: Public
stock_ticker: "NYSE: ACME"
valuation: "$213B Market Cap (Dec 2025)"
founded_date: 2006
...
quote_author: "Gabi Stefanini"
quote_title: "Director, Ruby and Rails Infrastructure"
member_status: "In 2022, Shopify became a **founding Core member** of the Rails Foundation."
github_contributions:
  - name: "Liquid - Template engine (created by Tobi Lütke)"
    url: "https://github.com/Shopify/liquid"
  - name: "shopify_app - A Rails Engine for building Shopify Apps"
    url: "https://github.com/Shopify/shopify_app"
  - name: "maintenance_tasks - Rails engine for queueing and managing maintenance tasks"
    url: "https://github.com/Shopify/maintenance_tasks"
  - name: "Ruby LSP - an opinionated language server for Ruby"
...
- RubyConf sponsor (multiple years)
- Tropical on Rails sponsor (multiple years)
- Ruby Association Platinum Sponsor
- Ruby Central Ruby Shield sponsor
- [Hosts "Rails at Scale" blog sharing insights from running massive Rails applications](https://railsatscale.com/)
- Hundreds of conference talks, podcast participation, blog posts
- Research grants to universities advancing Ruby and Rails theoretical and practical implementations
