...
valuation: "Not for sale. (See left.)"
founded_date: 2005
headquarters: "**Carlsbad, CA & Remote**"
employees_range: "225"
rails_engineers_range: "100"
rails_usage: |
  Planning Center is built almost entirely on Ruby on Rails and has been for nearly two decades. The platform consists of multiple Rails applications, where each product (Services, People, Groups, Giving, Registrations, Calendar, Check-Ins, Publishing, and more) runs as its own Rails app. In the world of majestic monoliths and microservices, they've carved out a path of macroservices. (They call it the "Stonehenge architecture." Nobody really remembers why it was made that way, but it works and people keep coming back to see it.)<br><br>
  Rails powers all of their customer-facing web applications that churches use to manage their operations, the API backends for their mobile apps and public developer API, the Church Center web experience (a congregation-facing product), and their internal tools, account management, and billing systems. If it runs at Planning Center, it runs on Rails.<br><br>
  A 220-person bootstrapped company serving 90,000+ churches, running on Rails for nearly 19 years with no outside investment, no major rewrites, and a team of 100 engineers. Rails isn't just part of Planning Center's stack. It's the whole stack.
...
quote_author: "Jeff Berg"
quote_title: "CEO, CTO, & Founder"
member_status: "In 2026, Planning Center became a **contributing member** of the Rails Foundation."
