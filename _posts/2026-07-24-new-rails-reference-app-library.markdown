---
layout: post
title: "New Rails reference app library published"
...
Today we're adding a new page to the Ruby on Rails website: **[Reference Apps](/docs/reference-apps)**. This is a small, hand-picked library of real, open-source Rails applications worth studying.
...
- **Campfire** - a complete, real-time group chat app.
- **Writebook** - a self-hosted platform for publishing books on the web.
- **Fizzy** - a Kanban board reimagined.

**Wait, they’re all from…**

Yes, so far they’re all apps built by 37signals. (That even <a href="https://github.com/rails/website/pull/684#issuecomment-5064970431">caught DHH by surprise</a>.)
...
You can find the library now on the [Docs](/docs) page, or go straight to [/docs/reference-apps](/docs/reference-apps)

[Take a look](/docs/reference-apps) and let us know what you think!

Send us your feedback at <a href="mailto:foundation@rubyonrails.org">foundation@rubyonrails.org</a>.

<p style="text-align: center;"><img src="/assets/images/reference-app-page.png" style="width: 55%;"></p>
