...
Rails 8.1 represents the work of [over 500 contributors](https://contributors.rubyonrails.org/edge/contributors) across 2500 commits since our last major release. After some
weeks of people trying the betas and releases candidates, we are excited to share the final release.
