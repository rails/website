...
**Open-sourcing it all.** The [tasks and methodology](https://github.com/rails/ai-evals) are available now, and the raw runs will be uploaded into the repo tomorrow. Soon **lemans**, the Ruby harness that Evil Martians built to run all of this, will also be open sourced for the community.
